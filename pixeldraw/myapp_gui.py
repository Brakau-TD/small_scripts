...
class AppGui:
    ...
    def initialize_dictionary(self) -> dict:
        ...
        self.radb1 = tk.Radiobutton(
                self._left_frame,
                text="Radiobutton 1",
                variable=self.radio,
                value=1,
            )
        self.radb2 =  tk.Radiobutton(
                self._left_frame,
                text="Radiobutton 2",
                variable=self.radio,
                value=2,
    ...
    def _create_gui(self, dictkeys):
        ...
        for key in dictkeys:
            for element in self._gui_elements[key]:
                print(f"packing {key} {element} in self._create_gui()")
                if element == "T2":
                    print(f"creating Textbox widget for {element} in self._create_gui()")
    ...
    def app_function_one(self):
        ...
        self.hp.suche_etwas(self._text_variables[0].get())
